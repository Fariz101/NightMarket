...
import { items } from "@/app/seller/seller_menus";
...
export function AppSidebar() {
  ...
  return (
    ...
    >
      ...
      <SidebarHeader className="h-20 flex items-center justify-center border-b border-cyan-950/80 px-4 select-none relative before:content-[''] before:absolute before:bottom-0 before:left-0 before:w-4 before:h-[2px] before:bg-orange-500">
                ...
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 rounded transition-all relative border ${
                      isActive
                        ? "bg-[#041a30] text-orange-400 border-cyan-500/60 shadow-[0_0_15px_rgba(6,182,212,0.15)] before:content-[''] before:absolute before:left-0 before:top-2 before:bottom-2 before:w-[3px] before:bg-orange-500"
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              ...
              >
                <LogOut className="w-4 h-4 flex-shrink-0 text-red-500 group-hover:animate-pulse" />
